...
def _valuespec_active_checks_dnos_diffcfg():
    return Dictionary(
        ...
        required_keys=['user', 'password', 'server', 'token'],
    )
...
rulespec_registry.register(
    HostRulespec(
        ...
        match_type='all',
        name='active_checks:dnos_diffcfg',
        valuespec=_valuespec_active_checks_dnos_diffcfg,
    ))
